...
export default function CommercialOffers() {
  ...
  // Filter only commercial vehicles
  const commercialOffers = useMemo(() =>
    offers.filter(o => o.category === "Commercial Van"),
    [offers]
  );

  // Deduplicate by make+model keeping lowest price
  const vehicles = useMemo(() => {
    const vehicleMap = new Map();
    commercialOffers.forEach(o => {
  ...
  const fuelTypes = useMemo(() => [...new Set(commercialOffers.map(o => o.fuel_type).filter(Boolean))], [commercialOffers]);
