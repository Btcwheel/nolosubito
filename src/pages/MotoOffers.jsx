...
export default function MotoOffers() {
  ...
  const { data: vehicles = [], isLoading } = useQuery({
    ...
    queryFn: () => offersService.listWithMinPrice("Moto"),
  });
    ...
    <div className="space-y-5">
      <div>
        ...
        <Select value={categoryFilter} onValueChange={setCategoryFilter}>
          <SelectTrigger className="h-11"><SelectValue placeholder="Tutti i tipi" /></SelectTrigger>
          <SelectContent>
        ...
        <div className="relative pt-24 sm:pt-28 pb-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            ...
            <p className="mt-3 text-white/50 max-w-xl text-sm sm:text-base leading-relaxed">
              Scooter, naked, touring e sportive in Noleggio Lungo Termine.<br className="hidden sm:block" />
            ...
            <div className="flex flex-wrap gap-2 mt-5">
              {[
                ...
                { icon: Zap,    label: "Moto sostitutiva H24" },
              ].map(({ icon: Icon, label }) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex gap-3 mb-8">
            ...
            <div className="hidden sm:flex gap-3">
              ...
              <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                <SelectTrigger className="w-44 h-11"><SelectValue placeholder="Tipo" /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">Tutti i tipi</SelectItem>
                  {categories.map(c => <SelectItem key={c} value={c}>{c}</SelectItem>)}
                </SelectContent>
          ...
          {!isLoading && (
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">moto disponibili</span>
                {activeFilters > 0 && (
          ...
          {isLoading ? (
            ...
            <div className="text-center py-24">
              ...
              <p className="font-heading font-semibold text-lg text-foreground">Nessuna moto trovata</p>
