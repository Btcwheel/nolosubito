  ...
  return (
    <div className="bg-[#F5F6FA] min-h-screen">
      <PageHeader
        ...
        title="Offerte Moto"
        description="Scooter, naked, touring e sportive in Noleggio Lungo Termine. Assicurazione, manutenzione e soccorso stradale inclusi nel canone."
      />
      ...
      >
        ...
        <NativeSelect
          ...
          options={[{ value: "all", label: "Tutti i tipi" }, ...categories.map(c => ({ value: c, label: c }))]}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        {isLoading ? (
          ...
          <div className="text-center py-20 text-gray-400">
            <p className="text-lg font-semibold mb-1">Nessuna moto trovata</p>
