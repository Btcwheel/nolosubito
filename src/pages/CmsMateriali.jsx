    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={() => setShowModal(true)}
          ...
          <Plus className="size-4" /> Nuovo Materiale
        </Button>
      </div>
            ...
            {materiali.map(m => {
              ...
              return (
                <div key={m.id} className="flex items-center gap-4 px-5 py-3 hover:bg-muted/20 transition-colors">
                  <div className="size-9 rounded-xl bg-navy/8 flex items-center justify-center shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                      ...
                      {m.visibilita === "tutti"
                        ? <span className="flex items-center gap-0.5 text-xs text-muted-foreground"><Globe className="size-3" /> Tutti gli agenti</span>
                        : <span className="flex items-center gap-0.5 text-xs text-muted-foreground"><Users className="size-3" /> {agentiCount} agenti</span>
                      }
                      {m.expires_at && (
                  ...
                  <a href={m.file_url} target="_blank" rel="noopener noreferrer">
                    <Button size="sm" variant="ghost" className="size-8 p-0 hover:bg-muted">
