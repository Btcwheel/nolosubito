...
const SERVIZI_NOLOSUBITO_MAP = {
  ...
  'MANUTENZIONE': ['Manutenzione', 'Ordinaria e Straordinaria'],
  ...
  'CONSEGNA': ['Consegna Veicolo', 'Consegna presso hub più vicino al cliente'],
  'BOLLO': ['Tassa di Proprietà', 'Gestione con riaddebito mensile'],
...
const SERVIZI_CANONICAL_MAP = {
  ...
  'Tassa di Proprietà': ['Tassa di Proprietà', 'Gestione con riaddebito mensile'],
...
const SERVIZI_DEFAULT = [
  ...
  ['Tassa di Proprietà', 'Gestione con riaddebito mensile'],
